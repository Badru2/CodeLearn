                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="/halamanAdmin"><i class="bi bi-layout-text-sidebar-reverse"></i>Dashboard</a></li>
                                <li>
                        ...
                        @else
                        <li class="nav-item">
                            <a href="/login" class="nav-link"> <span class="mr-2 d-none d-lg-inline text-gray-600 small">Login</span></a>
                        </li>
                        @endauth
                    </ul>
