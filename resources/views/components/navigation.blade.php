    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active fw-bold fs-3" aria-current="page" href="{{ route('user.index') }}">Home</a>
                </li>
                <li class="nav-item"><a class="nav-link fw-bold fs-3" href="{{ route('user.halamanLaravel') }}">Laravel</a></li>
                <li class="nav-item"><a class="nav-link fw-bold fs-3" href="{{ route('user.halamanjavascript') }}">JavaScript</a></li>
                ...
                <div class="container-fluid d-grid">
                    <form action="{{route('user.index')}}" method="GET" class="mt-3 mx-auto max-w-xl py-2 px-6 rounded-full bg-white border flex focus-within:border-gray-300 ">
